                ...
                <div id="analyst_journal_table_container">
                    <div id="analyst_journal_container">
                        <div id="analyst_journal_left_container">
                            <div id="analyst_journal_info_container">
                                <label class="analyst_label">Title: </label>
                                    <br>
                                <input type="text" id="title" class="analyst_input" value="" readonly>
                                    <br>
                                <label class="analyst_label">Author: </label>
                                    <br>
                                <input type="text" id="author" class="analyst_input" value="" readonly>
                                    <br>
                                <label class="analyst_label">Date: </label>
                                    <br>
                                <input type="text" id="year" class="analyst_input" value="" readonly>
                                    <br>
                                <label class="analyst_label">DOI: </label>
                                    <br>
                                <input type="text" id="doi" class="analyst_input" value="" readonly>
                                    <br>
                            </div>
                        </div>
                        <div id="analyst_journal_right_container">
                            ...
                            <br>
                            <textarea id="description" rows="9" cols="48" class="analyst_input" readonly>
                            </textarea>
                        </div>
                    </div>
